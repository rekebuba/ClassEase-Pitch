            ...
            <table className="data-table">
                <thead>
                    <tr>
                        ...
                        <th>G.Father Name</th>
                        <th>Section</th>
                        <th className="w-fit">AVR Score <span>
                            <TableSortLabel
                                active={sort}
                                ...
                                onClick={(e) => {
                                    ...
                                    setSort(true);
                                    handleSearch(e, currentPage, { 'order_by': 'final_score', 'order': order })
                                }}
                            >
                            </TableSortLabel>
                        </span></th>
 ...
 */
const AdminStudentList = ({ toggleProfile, profileSummary }) => {
     ...
     */
    const handleSearch = async (e, page, orderBy) => {
