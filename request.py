...
if __name__ == "__main__":
    ...
    show_admin_mark_list = "http://0.0.0.0:5000/api/v1/admin/students/mark_list?grade=12&section=B&subject=english"


    show_teacher_mark_list = "http://0.0.0.0:5000/api/v1/teacher/students/mark_list?grade=12&section=A"
