...
from sqlalchemy import CheckConstraint, ForeignKey, Text, String, Integer, Boolean, Date, DateTime, Enum
...
class Event(BaseModel):
    ...
    purpose: Mapped[str] = mapped_column(String(50), Enum('Academic', 'Cultural', 'Sports', 'Graduation',
                                                          'Administration', 'New Semester', 'Other'), nullable=False)
    organizer: Mapped[str] = mapped_column(String(50), Enum('School Administration',
    ...
    location: Mapped[str] = mapped_column(String(50), Enum(
    ...
    eligibility: Mapped[str] = mapped_column(String(50), Enum(
        'All', 'Students Only', 'Faculty Only', 'Invitation Only'), nullable=True, default=None)
