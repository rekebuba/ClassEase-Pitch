...
class ApplicationAddress(SchoolScopedMixin, TimestampMixin):
    __tablename__ = "application_addresses"
    ...
    __table_args__ = (
        ...
        UniqueConstraint("school_id", "application_id", name="uq_school_app_addresses_per_application"),
    )
