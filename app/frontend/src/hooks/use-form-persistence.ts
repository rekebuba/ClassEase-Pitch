...
export function useFormPersistence() {
    ...
    const saveFormData = useCallback((data: StudentRegistrationFormData, currentStep: number) => {
    ...
    const loadFormData = useCallback((): { data: Partial<StudentRegistrationFormData>; step: number } | null => {
        try {
