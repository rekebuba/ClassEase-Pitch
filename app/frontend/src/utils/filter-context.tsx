...
const FilterContext = createContext<ReturnType<typeof useFiltersContext> | null>(null);
...
function useFiltersContext<TData>(columnIds: string[]) {
    ...
    return { filters, setFilters, addFilter, removeFilter, clearFilters, getFilter, debouncedAddFilter };
}
