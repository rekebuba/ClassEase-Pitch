    ...
    return (
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent className="sm:max-w-xl w-full overflow-y-auto">
                <SheetHeader>
                    <SheetTitle>{isNewStudent ? "Add New Student" : "Edit Student"}</SheetTitle>
                    <SheetDescription>
                        {isNewStudent ? "Add a new student to the system." : "Make changes to the student's information."}
                    </SheetDescription>
                </SheetHeader>
                ...
                <form onSubmit={handleSubmit} className="space-y-6 py-6">
                    ...
                    <SheetFooter>
                        ...
                        <Button type="submit" disabled={isSubmitting}>
                            {isSubmitting ? "Saving..." : isNewStudent ? "Add Student" : "Save Changes"}
                        </Button>
                    </SheetFooter>
                </form>
            </SheetContent>
