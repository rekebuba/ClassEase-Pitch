              ...
              <CardContent>
                <div className="flex flex-wrap gap-2">
                  <Button
                    size="sm"
                    variant={
                      teacher.status === "under-review" ? "default" : "outline"
                    }
                  ...
                  <Button
                    size="sm"
                    variant={
                      teacher.status === "interview-scheduled"
                        ? "default"
                        : "outline"
                    }
                  ...
                  <Button
                    size="sm"
                    variant={
                      teacher.status === "approved" ? "default" : "outline"
                    }
                    ...
                    <CardContent className="space-y-3">
                      ...
                      <div>
                        ...
                        {teacher.secondaryPhone && (
                          <p>Secondary: {teacher.secondaryPhone}</p>
                        )}
                      </div>
                      <div>
                        <p className="text-sm font-medium text-gray-500 flex items-center gap-1">
                    ...
                    <CardContent className="space-y-3">
                      <div>
                        ...
                        {teacher.teachingLicense && (
                          <div className="mt-2 space-y-1">
                            ...
                            <p className="text-sm">
                              State: {teacher.licenseState}
                            </p>
                            <p className="text-sm">
                              Expires:{" "}
                              {teacher.licenseExpirationDate &&
                                formatDate(teacher.licenseExpirationDate)}
                            </p>
                          </div>
                        )}
                      </div>
                      ...
                      {teacher.preferredSchedule && (
                        <div>
                          ...
                          <p className="capitalize">
                            {teacher.preferredSchedule.replace("-", " ")}
                          </p>
                        </div>
                      )}
                    </CardContent>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {[
                        ...
                        {
                          label: "Cover Letter",
                          file: teacher.coverLetter,
                          required: false,
                        },
                        {
                          label: "Transcripts",
                          file: teacher.transcripts,
                          required: false,
                        },
                        {
                          label: "Teaching Certificate",
                          file: teacher.teachingCertificate,
                          required: false,
                        },
                        {
                          label: "Background Check",
                          file: teacher.backgroundCheck,
                          required: false,
                        },
                      ].map((doc) => (
                        <div
