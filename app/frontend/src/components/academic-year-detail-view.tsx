...
export default function AcademicYearDetailView({
  detailAcademicYears,
  onBack,
  onEdit,
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-1">
              ...
              <span className="text-sm text-gray-600">
                {formatDate(detailAcademicYears.startDate)} -{" "}
                {formatDate(detailAcademicYears.endDate)}
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <p className="font-medium capitalize">
                {detailAcademicYears.calendarType}
              </p>
            </div>
            <div>
              <h4 className="font-medium text-sm text-gray-600 mb-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <div className="font-medium">
                {formatDate(detailAcademicYears.createdAt)}
              </div>
            </div>
            <div>
              <span className="text-gray-600">Last Updated:</span>
              <div className="font-medium">
                {formatDate(detailAcademicYears.updatedAt)}
              </div>
            </div>
          </div>
        </CardContent>
...
function GradeDetails({
  ...
  const fetchGrade = async (gradeId: string) => {
    ...
    if (!response.success) {
      ...
      throw new Error(
        "Failed to fetch Grade detail: " + response.error.message,
      );
    }
  ...
  return (
    <Card>
      ...
      <FadeIn
        isLoading={!(detailAcademicYears.grades.length === detailGrade.length)}
        loader={<CardSkeleton />}
      >
...
function SubjectDetails({
  ...
  return (
    <Card>
      ...
      <FadeIn
        isLoading={
          !(detailAcademicYears.subjects.length === detailSubject.length)
        }
        loader={<CardSkeleton />}
      >
        <CardContent className="space-y-4">
