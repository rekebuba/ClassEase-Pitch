...
import { BookOpen, Edit, Trash2, GraduationCap, Users, MoreHorizontal, Eye } from "lucide-react"
import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuItem,
...
export function SubjectCard({ subject, grades, onEdit, onDelete, onView }: SubjectCardProps) {
            ...
            <CardContent className="space-y-4 flex-grow">
                ...
                <div className="grid grid-cols-2 gap-2">
                    <div className="text-center p-2 bg-blue-50 rounded-lg">
                        ...
                        <div className="text-sm font-semibold text-blue-900">{grades.length}</div>
