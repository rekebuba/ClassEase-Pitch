  ...
  admin: {
    ...
    navMain: [
      ...
      },
      {
        ...
        icon: Calendar,
        href: "#",
        items: [{ title: "Events", href: "/admin/calendar/events" }],
      },
      {
        title: "Assessments",
        icon: FileText,
        href: "#",
        items: [{ title: "Mark List", href: "/admin/assessment/mark-list" }],
      },
      {
        title: "Setup",
        icon: Cog,
        ...
        items: [
          { title: "Academic Year", href: "/admin/academic-year-setup" },
          {
            ...
            href: "/admin/academic-year-manage",
          },
        ],
      },
    ],
...
export type PartialUser = Pick<
  User,
  "id" | "role" | "identification" | "imagePath"
>;
export type PartialAdmin = Pick<
  Admin,
  "firstName" | "fatherName" | "grandFatherName"
>;
export type PartialTeacher = Pick<
  Teacher,
  "firstName" | "fatherName" | "grandFatherName"
>;
export type PartialStudent = Pick<
  Student,
  "firstName" | "fatherName" | "grandFatherName"
>;
  ...
  const {
    ...
    queryFn: async () => {
      ...
      if (userRole === "admin") {
        ...
        const res = await adminApi.getUser(userId!, schema, {
          fields: [...fields],
        });
      ...
      if (userRole === "student") {
        ...
        const res = await studentApi.getUser(userId!, schema, {
          fields: [...fields],
        });
        if (!res.success) throw new Error(res.error.message);
        return res.data;
      ...
      if (userRole === "teacher") {
        ...
        const res = await teacherApi.getUser(userId!, schema, {
          fields: [...fields],
        });
        if (!res.success) throw new Error(res.error.message);
        return res.data;
  ...
  return (
    <Sidebar collapsible="icon" {...props}>
      ...
      <SidebarFooter className="border-t p-4">
        ...
        >
          {userData && roleData && (
            <NavUser user={userData} roleData={roleData} />
          )}
        </FadeIn>
      </SidebarFooter>
      <SidebarRail />
