...
export const allSubjectsData: SubjectInfo[] = [
    // Grade 1
    { id: crypto.randomUUID(), name: "Arts and Physical Education", code: "ART1", grade: 1 },
    { id: crypto.randomUUID(), name: "Environmental Science", code: "ENV1", grade: 1 },
    ...
    // Grade 2
    { id: crypto.randomUUID(), name: "Arts and Physical Education", code: "ART2", grade: 2 },
    { id: crypto.randomUUID(), name: "Environmental Science", code: "ENV2", grade: 2 },
    ...
    // Grade 3
    { id: crypto.randomUUID(), name: "Arts and Physical Education", code: "ART3", grade: 3 },
    { id: crypto.randomUUID(), name: "Environmental Science", code: "ENV3", grade: 3 },
    ...
    // Grade 4
    { id: crypto.randomUUID(), name: "Arts and Physical Education", code: "ART4", grade: 4 },
    { id: crypto.randomUUID(), name: "Environmental Science", code: "ENV4", grade: 4 },
    ...
    // Grade 5
    { id: crypto.randomUUID(), name: "Integrated Science", code: "INT5", grade: 5 },
    { id: crypto.randomUUID(), name: "Visual Arts and Music", code: "VIS5", grade: 5 },
    ...
    { id: crypto.randomUUID(), name: "Physical Education", code: "PHY5", grade: 5 },
    { id: crypto.randomUUID(), name: "Civics and Ethical Education", code: "CIV5", grade: 5 },

    // Grade 6
    { id: crypto.randomUUID(), name: "Integrated Science", code: "INT6", grade: 6 },
    { id: crypto.randomUUID(), name: "Visual Arts and Music", code: "VIS6", grade: 6 },
    ...
    { id: crypto.randomUUID(), name: "Physical Education", code: "PHY6", grade: 6 },
    { id: crypto.randomUUID(), name: "Civics and Ethical Education", code: "CIV6", grade: 6 },

    // Grade 7
    { id: crypto.randomUUID(), name: "Social Study", code: "SOC7", grade: 7 },
    { id: crypto.randomUUID(), name: "Visual Arts and Music", code: "VIS7", grade: 7 },
    ...
    { id: crypto.randomUUID(), name: "Physical Education", code: "PHY7", grade: 7 },
    { id: crypto.randomUUID(), name: "Civics and Ethical Education", code: "CIV7", grade: 7 },
    ...
    { id: crypto.randomUUID(), name: "Visual Arts and Music", code: "VIS8", grade: 8 },
    ...
    { id: crypto.randomUUID(), name: "Physical Education", code: "PHY8", grade: 8 },
    { id: crypto.randomUUID(), name: "Civics and Ethical Education", code: "CIV8", grade: 8 },
    ...
    // Grade 9
    { id: crypto.randomUUID(), name: "Amharic as second language", code: "AMH9", grade: 9 },
    ...
    { id: crypto.randomUUID(), name: "Physical Education", code: "PHY9", grade: 9 },
    { id: crypto.randomUUID(), name: "Civics and Ethical Education", code: "CIV9", grade: 9 },
    ...
    { id: crypto.randomUUID(), name: "Information Technology", code: "INF9", grade: 9 },
    ...
    { id: crypto.randomUUID(), name: "Physical Education", code: "PHY10", grade: 10 },
    { id: crypto.randomUUID(), name: "Civics and Ethical Education", code: "CIV10", grade: 10 },
    { id: crypto.randomUUID(), name: "Information Technology", code: "INF10", grade: 10 },
    ...
    { id: crypto.randomUUID(), name: "Physical Education", code: "PHY11", grade: 11 },
    { id: crypto.randomUUID(), name: "Civics and Ethical Education", code: "CIV11", grade: 11 },
    ...
    { id: crypto.randomUUID(), name: "Physical Education", code: "PHY12", grade: 12 },
    { id: crypto.randomUUID(), name: "Civics and Ethical Education", code: "CIV12", grade: 12 },
...
export const allSubjects = Object.values(
    allSubjectsData.reduce((acc, { id, name, code }) => {
        if (!acc[name]) {
