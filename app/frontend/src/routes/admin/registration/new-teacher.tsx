...
function RouteComponent() {
  ...
  const [formData, setFormData] =
    useState<TeacherRegistrationFormData>(initialFormData);
  ...
  const updateFormData = (
    field: keyof TeacherRegistrationFormData,
    value: any,
  ) => {
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 gap-4">
              ...
              >
                <InputWithError
                  ...
                  onChange={(e) =>
                    handleFieldChange("positionApplyingFor", e.target.value)
                  }
              ...
              >
                <InputWithError
                  ...
                  onChange={(e) =>
                    handleFieldChange("salaryExpectation", e.target.value)
                  }
                  placeholder="$50,000"
                  error={errors.salaryExpectation}
                />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <SelectWithError
                  ...
                  onValueChange={(value) =>
                    handleFieldChange("highestDegree", value)
                  }
                ...
                {errors.highestDegree && (
                  <p className="text-red-500 text-sm">{errors.highestDegree}</p>
                )}
              </div>
            ...
            >
              <TextareaWithError
                ...
                onChange={(e) =>
                  handleFieldChange("specialSkills", e.target.value)
                }
          ...
          <div className="space-y-6">
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleFieldChange("teachingLicense", checked)
                  }
                />
                <Label htmlFor="teachingLicense">
                  Do you have a valid teaching license?
                </Label>
              </div>
                ...
                <div className="ml-6 space-y-4 p-4 bg-yellow-50 rounded-lg">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <FormField
                      ...
                      success={
                        !errors.licenseState && touchedFields.licenseState
                      }
                    >
                      <InputWithError
                        id="licenseState"
                        ...
                        onChange={(e) =>
                          handleFieldChange("licenseState", e.target.value)
                        }
                  ...
                  <FormField
                    ...
                    success={
                      ...
                      touchedFields.licenseExpirationDate
                    }
                  >
                    <InputWithError
                      id="licenseExpirationDate"
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <SelectWithError
                  ...
                  onValueChange={(value) =>
                    handleFieldChange("yearsOfExperience", value)
                  }
            ...
            >
              <TextareaWithError
                ...
                onChange={(e) =>
                  handleFieldChange("previousSchools", e.target.value)
                }
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                  {subjects.map((subject) => (
                    <div key={subject} className="flex items-center space-x-2">
                      <Checkbox
                        id={subject}
                        checked={(formData.subjectsToTeach || []).includes(
                          subject,
                        )}
                        onCheckedChange={() =>
                          handleArrayToggle("subjectsToTeach", subject)
                        }
                      />
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-600">
                  Select all grade levels you are qualified to teach:
                </p>
                <div className="grid grid-cols-3 md:grid-cols-5 gap-2">
                  {gradeLevels.map((grade) => (
                    <div key={grade} className="flex items-center space-x-2">
                      <Checkbox
                        id={grade}
                        checked={(formData.gradeLevelsToTeach || []).includes(
                          grade,
                        )}
                        onCheckedChange={() =>
                          handleArrayToggle("gradeLevelsToTeach", grade)
                        }
                      />
            ...
            <div className="space-y-2">
              ...
              <SelectWithError
                ...
                onValueChange={(value) =>
                  handleFieldChange("preferredSchedule", value)
                }
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleFieldChange("hasConvictions", checked)
                  }
                />
                ...
                <div className="ml-6 space-y-2 p-4 bg-red-50 rounded-lg">
                  <FormField
                    ...
                    success={
                      ...
                      touchedFields.convictionDetails
                    }
                  >
                    <TextareaWithError
                      id="convictionDetails"
                      ...
                      onChange={(e) =>
                        handleFieldChange("convictionDetails", e.target.value)
                      }
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleFieldChange("hasDisciplinaryActions", checked)
                  }
                />
                <Label htmlFor="hasDisciplinaryActions">
                  Have you ever been subject to disciplinary action in any
                  previous employment?
                </Label>
              </div>
              ...
              {formData.hasDisciplinaryActions && (
                <div className="ml-6 space-y-2 p-4 bg-orange-50 rounded-lg">
                  <FormField
                    ...
                    success={
                      !errors.disciplinaryDetails &&
                      touchedFields.disciplinaryDetails
                    }
                  >
                    <TextareaWithError
                      id="disciplinaryDetails"
                      ...
                      onChange={(e) =>
                        handleFieldChange("disciplinaryDetails", e.target.value)
                      }
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  >
                    <InputWithError
                      ...
                      onChange={(e) =>
                        handleFieldChange("reference1Name", e.target.value)
                      }
                  ...
                  >
                    <InputWithError
                      ...
                      onChange={(e) =>
                        handleFieldChange("reference1Title", e.target.value)
                      }
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  >
                    <InputWithError
                      ...
                      onChange={(e) =>
                        handleFieldChange("reference1Email", e.target.value)
                      }
              ...
              <div className="space-y-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField
                    ...
                    success={
                      !errors.reference2Name && touchedFields.reference2Name
                    }
                  >
                    <InputWithError
                      id="reference2Name"
                      ...
                      onChange={(e) =>
                        handleFieldChange("reference2Name", e.target.value)
                      }
                      placeholder="Enter reference name"
                      error={errors.reference2Name}
                    />
                  ...
                  <FormField
                    ...
                    success={
                      !errors.reference2Title && touchedFields.reference2Title
                    }
                  >
                    <InputWithError
                      id="reference2Title"
                      ...
                      onChange={(e) =>
                        handleFieldChange("reference2Title", e.target.value)
                      }
                      placeholder="e.g., Principal, Department Head"
                      error={errors.reference2Title}
                    />
                ...
                <FormField
                  ...
                  success={
                    ...
                    touchedFields.reference2Organization
                  }
                >
                  <InputWithError
                    id="reference2Organization"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  >
                    <InputWithError
                      ...
                      onChange={(e) =>
                        handleFieldChange("reference2Email", e.target.value)
                      }
                      placeholder="reference@example.com"
                      error={errors.reference2Email}
                    />
              ...
              <div className="space-y-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  >
                    <InputWithError
                      ...
                      onChange={(e) =>
                        handleFieldChange("reference3Name", e.target.value)
                      }
                      placeholder="Enter reference name"
                      error={errors.reference3Name}
                    />
                  ...
                  >
                    <InputWithError
                      ...
                      onChange={(e) =>
                        handleFieldChange("reference3Title", e.target.value)
                      }
                      placeholder="e.g., Principal, Department Head"
                      error={errors.reference3Title}
                    />
                ...
                <FormField
                  ...
                  success={
                    !errors.reference3Organization &&
                    touchedFields.reference3Organization
                  }
                >
                  <InputWithError
                    id="reference3Organization"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <FormField
                    ...
                    success={
                      !errors.reference3Email && touchedFields.reference3Email
                    }
                  >
                    <InputWithError
                      id="reference3Email"
                      ...
                      onChange={(e) =>
                        handleFieldChange("reference3Email", e.target.value)
                      }
                      placeholder="reference@example.com"
                      error={errors.reference3Email}
                    />
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="teachingCertificate">
                  ...
                  {formData.teachingCertificate && (
                    <p className="text-sm text-green-600">
                      ✓ {formData.teachingCertificate.name}
                    </p>
                  )}
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <FormField
                ...
                success={
                  !errors.teachingPhilosophy && touchedFields.teachingPhilosophy
                }
              >
                <TextareaWithError
                  id="teachingPhilosophy"
                  ...
                  onChange={(e) =>
                    handleFieldChange("teachingPhilosophy", e.target.value)
                  }
                ...
                <p className="text-xs text-gray-500 mt-1">
                  {formData.teachingPhilosophy
                    ? formData.teachingPhilosophy.length
                    : 0}
                  /1000 characters
                </p>
              </FormField>
              ...
              >
                <TextareaWithError
                  ...
                  onChange={(e) =>
                    handleFieldChange("whyTeaching", e.target.value)
                  }
                ...
                />
                <p className="text-xs text-gray-500 mt-1">
                  {formData.whyTeaching ? formData.whyTeaching.length : 0}/500
                  characters
                </p>
              </FormField>
              ...
              <FormField
                ...
                success={
                  !errors.additionalComments && touchedFields.additionalComments
                }
              >
                <TextareaWithError
                  id="additionalComments"
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4 p-4 bg-gray-50 rounded-lg">
                <div className="flex items-start space-x-2">
                  ...
                  >
                    I agree to the terms and conditions of employment and
                    understand that all information provided is accurate and
                    complete. I understand that any false information may result
                    in rejection of my application or termination of employment.
                  </Label>
                </div>
                {errors.agreeToTerms && (
                ...
                <div className="flex items-start space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      handleFieldChange("agreeToBackgroundCheck", checked)
                    }
                  />
                  <Label
                    ...
                    className="text-sm leading-relaxed"
                  >
                    I authorize the school district to conduct a comprehensive
                    background check, including criminal history, employment
                    verification, and reference checks. I understand this is
                    required for all teaching positions.
                  </Label>
                </div>
