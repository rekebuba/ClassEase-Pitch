...
export const Route = createFileRoute("/dashboard/registration/students")({
...
function RouteComponent() {
  ...
  const handleView = (studentId: string) => {
    navigate({ to: "/dashboard/students/$studentId", params: { studentId } });
  };
        ...
        <Card>
          <CardHeader>
            <div className="flex justify-between items-center">
              ...
              <Button
                onClick={() =>
                  navigate({ to: "/dashboard/registration/new-student" })}
