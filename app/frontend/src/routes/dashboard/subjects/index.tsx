...
import {
  getSubjectOfferingsOptions,
  getSubjectOfferingsQueryKey,
  postSubjectMutation,
} from "@/client/@tanstack/react-query.gen";
import { zGetSubjectOfferingsQuery, zNewSubject } from "@/client/zod.gen";
...
export const Route = createFileRoute("/dashboard/subjects/")({
  beforeLoad: () => requireRoutePermission(Permission["subjects:read"]),
  validateSearch: zGetSubjectOfferingsQuery.pick({ q: true }),
...
function RouteComponent() {
  ...
  const {
    ...
    isLoading,
    error,
  } = useQuery(getSubjectOfferingsOptions(getSubjectsQueryConfig()));
  ...
  const newSubjectMutation = useMutation({
    ...
    onSuccess: (success) => {
      ...
      queryClient.invalidateQueries({
        queryKey: getSubjectOfferingsQueryKey(getSubjectsQueryConfig()),
      });
