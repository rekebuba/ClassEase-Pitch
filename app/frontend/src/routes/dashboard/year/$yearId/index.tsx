...
export const Route = createFileRoute("/dashboard/year/$yearId/")({
  beforeLoad: () => requireRoutePermission(Permission["years:read"]),
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Button
            variant="outline"
            size="sm"
            onClick={() => navigate({ to: "/dashboard/year", params: { yearId } })}
          >
