...
export const Route = createFileRoute("/dashboard/manage-teachers/")({
  beforeLoad: () => requireRoutePermission(Permission["teachers:assign"]),
...
function RouteComponent() {
  ...
  //   navigate({ to: "/dashboard/employees/$employeeId", params: { employeeId } });
  // };
