...
import {
  getGradeOfferingsOptions,
  getGradeOfferingsQueryKey,
  postGradeMutation,
} from "@/client/@tanstack/react-query.gen";
import {
  zGetGradeOfferingsQuery,
  zGradeEnum,
  zGradeLevelEnum,
  zNewGrade,
} from "@/client/zod.gen";
...
export const Route = createFileRoute("/dashboard/grades/")({
  beforeLoad: () => requireRoutePermission(Permission["grades:read"]),
  validateSearch: zGetGradeOfferingsQuery.pick({ q: true }),
...
function RouteComponent() {
  ...
  const {
    ...
    isLoading,
    error,
  } = useQuery(getGradeOfferingsOptions(getGradesQueryConfig()));
  ...
  const newGradeMutation = useMutation({
    ...
    onSuccess: (success) => {
      ...
      queryClient.invalidateQueries({
        queryKey: getGradeOfferingsQueryKey(getGradesQueryConfig()),
      });
