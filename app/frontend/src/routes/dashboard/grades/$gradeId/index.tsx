...
export const Route = createFileRoute("/dashboard/grades/$gradeId/")({
  ...
  loader: async ({ params: { gradeId } }) => {
    ...
    if (yearId) {
      await queryClient.ensureQueryData(getGradesOptions());
    }
  },
...
function RouteComponent() {
  ...
  const { data: grades } = useQuery(getGradesOptions());

  const {
    data: subjects,
    isLoading: isSubjectsLoading,
    error: isSubjectsError,
  } = useQuery(getSubjectsOptions());
