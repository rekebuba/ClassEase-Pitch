    ...
    navBar: [
      {
        title: "Profile",
        icon: Info,
        to: "/dashboard/employees/$employeeId/profile",
        params: { employeeId },
      },
      {
        title: "Schedule",
        icon: BookOpen,
        to: "/dashboard/employees/$employeeId/schedule",
        params: { employeeId },
      },
      {
        title: "Interview",
        icon: BookOpen,
        to: "/dashboard/employees/$employeeId/interview",
        params: { employeeId },
      },
      {
        title: "Notes",
        icon: FileText,
        to: "/dashboard/employees/$employeeId/notes",
        params: { employeeId },
      },
    ],
    navMain: [],
...
function RouteComponent() {
  ...
  //       }),
  //     });
  //     navigate({ to: "/dashboard/registration/employees" });
  //   },
  //   onError: () => {
