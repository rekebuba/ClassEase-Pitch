...
const initialUsers = [
  {
    ...
    name: "John Doe",
    role: "Teacher",
    lastActivity: "Updated student grades",
    activityDate: "2024-10-09",
  },
  {
    id: 2,
    name: "Jane Smith",
    role: "Admin",
    lastActivity: "Added new teacher",
  ...
  },
  {
    ...
    name: "Mark Johnson",
    role: "Staff",
    lastActivity: "Updated attendance",
          ...
          <tbody>
            {users.map((user) => (
              <tr key={user.id}>
                ...
                <td>
                  {user.lastActivity} on {user.activityDate}
                </td>
                <td>
                  <button
