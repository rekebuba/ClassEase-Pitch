...
import type { TeacherApplication, TeacherApplicationWithDetails } from "@/lib/api-validation"
import { Layout, TeacherStatusBadge } from "@/components"
...
export default function ManageTeachersApplication() {
    ...
    const [selectedTeacher, setSelectedTeacher] = useState<TeacherApplicationWithDetails | null>(null)
