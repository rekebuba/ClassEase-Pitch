...
function AdminCreateMarkList() {
  ...
  const addAssessmentType = (e) => {
    ...
    const hasEmptyFields = assessmentTypes.some(
          ...
          {assessmentTypes.map((assessment, index) => (
            <div className="assessment-row" key={index}>
              ...
              >
                ...
                <option key={index} value="Test 1">
                  Test 1
                </option>
                <option key={index} value="Test 2">
                  Test 2
                </option>
                <option key={index} value="Test 3">
                  Test 3
                </option>
                ...
                <option key={index} value="Mid Exam">
                  Mid Exam
                </option>
                <option key={index} value="Final Exam">
                  Final Exam
                </option>
