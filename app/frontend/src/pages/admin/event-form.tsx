            ...
            <CardContent className="grid grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="School Administration">
              ...
              <div className="space-y-4">
                ...
                <Select
                  onValueChange={(value) =>
                    setFormData({
                      ...formData,
                      semester: { name: parseFloat(value) },
                    })
                  }
                >
                  <SelectTrigger>
                      ...
                      <Popover modal={true}>
                        <PopoverTrigger asChild>
                          ...
                          >
                            <CalendarIcon className="mr-2 h-4 w-4" />
                            {formData.registrationStart ? (
                              format(formData.registrationStart, "PPP")
                            ) : (
                              <span>Pick a date</span>
                            )}
                          </Button>
                      ...
                      <Popover modal={true}>
                        <PopoverTrigger asChild>
                          ...
                          >
                            <CalendarIcon className="mr-2 h-4 w-4" />
                            {formData.registrationEnd ? (
                              format(formData.registrationEnd, "PPP")
                            ) : (
                              <span>Pick a date</span>
                            )}
                          </Button>
              ...
              <div className="flex flex-col gap-6">
                <div className="flex items-center gap-2 mb-[-8px]">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      setFormData({ ...formData, hasFee: checked })
                    }
                  />
                </div>
