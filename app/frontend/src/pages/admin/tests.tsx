                            ...
                            <CardContent className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(value: "Semester" | "Quarter") => updateAcademicYear({ calendarType: value })}
                                    >
                                        <SelectTrigger>
                                            <SelectValue />
                                        </SelectTrigger>
                                        ...
                                        <CardContent className="p-4">
                                            ...
                                            <div className="grid grid-cols-2 gap-4 text-sm">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="font-medium capitalize">{academicYear.calendarType}</div>
                                                </div>
                                            </div>
                                        </CardContent>
                                    </Card>
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {GRADE_SUGGESTIONS.map((grade) => (
                                            <Button
                                                ...
                                                disabled={academicYear.grades?.some((g) => g.grade === grade.name)}
                                            >
