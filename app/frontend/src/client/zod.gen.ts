 ...
 * AuthProviderEnum
 */
export const zAuthProviderEnum = z.enum([
    'google',
    'password'
]);
...
export const zLoginProviderData = z.object({
    body: zProviderResponse,
    path: z.object({
...
export const zPasswordRecoveryData = z.object({
    body: zPasswordRecovery,
    path: z.optional(z.never()),
    query: z.optional(z.never())
});
...
export const zVerifyOtpData = z.object({
    body: zOtpRequest,
    path: z.optional(z.never()),
    query: z.optional(z.never())
});
...
export const zRegisterNewParentData = z.object({
    body: zParentRegistrationForm,
    path: z.optional(z.never()),
    query: z.optional(z.never())
});
...
export const zRegisterNewStudentData = z.object({
    ...
    query: z.optional(z.object({
        responses: z.optional(z.unknown()).default({
            400: {
                description: 'Invalid grade or parent ID'
            }
        })
    }))
});
