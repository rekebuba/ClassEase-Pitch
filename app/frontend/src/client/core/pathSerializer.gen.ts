...
type SerializeOptions<T> = {} & SerializePrimitiveOptions & SerializerOptions<T>;

type SerializePrimitiveOptions = {
  allowReserved?: boolean;
  name: string;
};

export type SerializerOptions<T> = {
  /**
   * @default true
   */
  explode: boolean;
