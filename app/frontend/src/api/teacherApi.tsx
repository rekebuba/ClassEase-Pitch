...
const teacherApi = {
  ...
  getStudents: (requirements) =>
    api.get("/teacher/students", { params: requirements }),
  getStudentAssessment: (requirements) =>
    api.get("/teacher/student/assessment", { params: requirements }),
