...
export const YearWithRelationSchema = YearSchema.extend(
  YearRelationSchema.shape,
);
export const GradeWithRelationSchema = GradeSchema.extend(
  GradeRelationSchema.shape,
);
export const StreamWithRelationSchema = StreamSchema.extend(
  StreamRelationSchema.shape,
);
export const SubjectWithRelationSchema = SubjectSchema.extend(
  SubjectRelationSchema.shape,
);
export const AcademicTermWithRelationSchema = AcademicTermSchema.extend(
  AcademicTermRelationSchema.shape,
);
