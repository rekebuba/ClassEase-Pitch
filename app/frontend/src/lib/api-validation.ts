...
export const TeacherApplicationWithDetailsSchema =
  TeacherApplicationSchema.merge(DetailTeacherAPPlicationSchema);

export type TeacherApplication = z.infer<typeof TeacherApplicationSchema>;
export type TeacherApplicationWithDetails = z.infer<
  typeof TeacherApplicationWithDetailsSchema
>;
